...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="width:100%; height:100%; left: 298px; top: 200px;"> 
            ...
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" width="60px"/>

            <EditRowStyle BackColor="#999999" />
            <FooterStyle Width="10%" BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <HeaderStyle Width="10%" HorizontalAlign="Left" Wrap="True" BackColor="#5D7B9D" Font-Bold="True" ForeColor="White" />
            <%--    <Columns>
        <asp:BoundField HeaderText="Server" DataField="ServerName" 
