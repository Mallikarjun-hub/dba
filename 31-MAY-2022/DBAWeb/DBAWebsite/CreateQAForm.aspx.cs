...
{
    public partial class CreateQAForm : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                if (Application["qa_Server_Name"] != null)
                    lblhead_servername.Text = Application["qa_Server_Name"].ToString();
            ...
            {
                string datepickervalue = Request.Form["txtDate"];
                inpHide.Value = datepickervalue;
            }
        }
        ...
        protected void buildForm_lables_DataBinding()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString))
            {
                ...
                {
                    Logging.LogException(ex, "Error while binding lables");
                }
        ...
        protected void Resource_name_dropdownlist_DataBinding()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                try
                {
                    ...
                    Logging.LogInfo("Successful binding on: QA Dropdown", true);
                }
                catch (Exception ex)
                {
        ...
        {
            DataTable qa_dbadb_info = new DataTable();            
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                try
                {
                    ...
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_dbadb_info.Load(reader);
                    dbadb_create_dropdownlist.DataSource = qa_dbadb_info;
        ...
        {
            DataTable qa_memoryCapped_info = new DataTable();       
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                try
                {
                    ...
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_memoryCapped_info.Load(reader);
                    memory_capped_dropdownlist.DataSource = qa_memoryCapped_info;
                    ...
                    Logging.LogInfo("Successful binding on: Memory Capped Dropdown", true);
                }
                catch (Exception ex)
                {
                    Logging.LogException(ex, "Error while executing the SP: usp_WebFormSelect");
        ...
        {
            DataTable qa_initialBackup_info = new DataTable();
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@query", SqlDbType.VarChar).Value = "initialbackup";
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_initialBackup_info.Load(reader);
                    Initial_backup_dropdownlist.DataSource = qa_initialBackup_info;
                    ...
                    Logging.LogInfo("Successful binding on: QA Drop Dropdown", true);
                }
                catch (Exception ex)
                {
                    Logging.LogException(ex, "Error while executing the SP: usp_WebFormSelect");
        ...
        {
            DataTable qa_backupScheduled_info = new DataTable();
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@query", SqlDbType.VarChar).Value = "backupscheduled";
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_backupScheduled_info.Load(reader);
                    backup_scheduled_dropdownlist.DataSource = qa_backupScheduled_info;
        ...
        {
            DataTable qa_driveLayout_info = new DataTable();
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@query", SqlDbType.VarChar).Value = "followdrivelayout";
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_driveLayout_info.Load(reader);
                    drive_layout_dropdownlist.DataSource = qa_driveLayout_info;
        ...
        protected void high_availability_dropdownlist_DataBinding()
        {
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                ...
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.Add("@query", SqlDbType.VarChar).Value = "highavailability";
                    conn.Open();
                    reader = cmd.ExecuteReader();
        ...
        {
            DataTable qa_noofProcessorsCores_info = new DataTable();
            ...
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                try
                {
                    ...
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_noofProcessorsCores_info.Load(reader);
                    processors_core_acknowledge_dropdownlist.DataSource = qa_noofProcessorsCores_info;
        ...
        {
            DataTable qa_mailSetup_info = new DataTable();
            SqlDataReader reader;
            using (SqlConnection conn = new SqlConnection(ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString))
            using (SqlCommand cmd = new SqlCommand("usp_WebFormSelect", conn))
            {
                try
                {
                    ...
                    conn.Open();
                    reader = cmd.ExecuteReader();
                    qa_mailSetup_info.Load(reader);
                    mail_setup_dropdownlist.DataSource = qa_mailSetup_info;
        ...
        {            
            ...
            string golive_date = inpHide.Value;
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    cmd.CommandText = "INSERT INTO QAFORM ([ServerName],[QAResource],[Resource_Notes],[dbadbCreated],[dbadbCreated_Notes],[MemoryCapped],[MemoryCapped_Notes],[InitialBackup],[InitialBackup_Notes],[BackupScheduled],[BackupScheduled_Notes],[GOLiveDate],[GOLiveDate_Notes],[FollowDriveLayout],[FollowDriveLayout_Notes],[SQLVersion],[SQLVersion_Notes],[MonitoringTool],[MonitoringTool_Notes],[HighAvailability],[HighAvailability_Notes],[No.ofProcessorsandcores],[No.ofProcessorsandcores_Notes],[MailSetup],[MailSetup_Notes],[OverallBuildnotes],[MemoryCorrect],[MemoryCorrect_Notes],[ServerAdministrators],[ServerAdministrators_Notes],[ServicesDisabled],[ServicesDisabled_Notes],[MaintenanceSet],[MaintenanceSet_Notes],[PagesLocked],[PagesLocked_Notes],[VersionCorrect],[VersionCorrect_Notes],[MaxdopSet],[MaxdopSet_Notes],[CostThreshold],[CostThreshold_Notes],[AuthenticationMode],[AuthenticationMode_Notes],[CountSet],[CountSet_Notes],[TraceFlag],[TraceFlag_Notes],[JobsVerified],[JobsVerified_Notes],[JobsSucessful],[JobsSucessful_Notes],[AgentAlerts],[AgentAlerts_Notes],[SecuritySetup],[SecuritySetup_Notes],[AccountsCorrect],[AccountsCorrect_Notes],[AccountsStored],[AccountsStored_Notes]) Values (@serevrname,@buildresource,@resourcenotes,@dbadb,@dbadbnotes,@memorycapped,@memorycappednotes,@initialbackup,@initialbackupnotes,@backupscheduled,@backupschedulednotes,@golivedate,@golivedatenotes,@drivelayout,@drivelayoutnotes,@sqlversion,@sqlversionnotes,@monitoringtool,@monitoringtoolnotes,@highavailability,@highavailabilitynotes,@processoracknowledge,@processoracknowledgenotes,@mailsetup,@mailsetupnotes,@overallbuildnotes,@memorycorrect,@memorycorrectnotes,@admincorrect,@admincorrectnotes,@servicesdisabled,@servicesdisablednotes,@maintenanceset,@maintenancesetnotes,@pagelock,@pagelocknotes,@versioncorrect,@versioncorrectnotes,@maxdop,@maxdopnotes,@threshold,@thresholdnotes,@mixedmode,@mixedmodenotes,@countset,@countsetnotes,@traceflag,@traceflagnotes,@jobsverified,@jobsverifiednotes,@jobssuccessful,@jobssuccessfulnotes,@agentalerts,@agentalertsnotes,@securitysetup,@securitysetupnotes,@accountscorrect,@accountscorrectnotes,@accountsstored,@accountsstorednotes)";
                    ...
                    param[5] = new SqlParameter("@resourcenotes", SqlDbType.NVarChar, 100);
                    param[6] = new SqlParameter("@dbadb", SqlDbType.NVarChar, 50);
                    param[7] = new SqlParameter("@dbadbnotes", SqlDbType.NVarChar, 100);
                    param[8] = new SqlParameter("@memorycapped", SqlDbType.NVarChar, 50);
                    param[9] = new SqlParameter("@memorycappednotes", SqlDbType.NVarChar, 100);
                    param[10] = new SqlParameter("@initialbackup", SqlDbType.NVarChar, 50);
                    param[11] = new SqlParameter("@initialbackupnotes", SqlDbType.NVarChar, 100);
                    param[12] = new SqlParameter("@backupscheduled", SqlDbType.NVarChar, 50);
                    param[13] = new SqlParameter("@backupschedulednotes", SqlDbType.NVarChar, 100);
                    param[14] = new SqlParameter("@golivedate", SqlDbType.NVarChar, 50);
                    param[15] = new SqlParameter("@golivedatenotes", SqlDbType.NVarChar, 100);
                    param[16] = new SqlParameter("@drivelayout", SqlDbType.NVarChar, 50);
                    param[17] = new SqlParameter("@drivelayoutnotes", SqlDbType.NVarChar, 100);
                    param[18] = new SqlParameter("@sqlversion", SqlDbType.NVarChar, 50);
                    param[19] = new SqlParameter("@sqlversionnotes", SqlDbType.NVarChar, 100);
                    param[20] = new SqlParameter("@monitoringtool", SqlDbType.NVarChar, 50);
                    param[21] = new SqlParameter("@monitoringtoolnotes", SqlDbType.NVarChar, 100);
                    param[22] = new SqlParameter("@highavailability", SqlDbType.NVarChar, 50);
                    param[23] = new SqlParameter("@highavailabilitynotes", SqlDbType.NVarChar, 100);
                    param[24] = new SqlParameter("@processoracknowledge", SqlDbType.NVarChar, 50);
                    param[25] = new SqlParameter("@processoracknowledgenotes", SqlDbType.NVarChar, 100);
                    param[26] = new SqlParameter("@mailsetup", SqlDbType.NVarChar, 50);
                    param[27] = new SqlParameter("@mailsetupnotes", SqlDbType.NVarChar, 100);
                    ...
                    string url = ResolveUrl("~/CreateQAForm.aspx");
                    if (rowsAffected == 1)
            ...
            {
                Logging.LogException(ex, "Error while inserting into database -- qaform");
                string url = ResolveUrl("~/CreateQAForm.aspx");
                Response.Write(String.Format("<script>alert('OOps there was an error while inserting in to database!');window.location='{0}';</script>", url));       
            }
            finally
