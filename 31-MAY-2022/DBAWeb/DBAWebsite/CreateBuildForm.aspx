            ...
            <table width="1000px">
                ...
                <tr>
                  ...
                  <%--<tr>
                    ...
                    <td valign="top">
                        <asp:DropDownList ID="memory_correct_dropdownlistt" runat="server" AppendDataBoundItems="true" DataTextField="key" DataValueField="value">
                            <asp:ListItem> </asp:ListItem>
                        </asp:DropDownList>
                    </td>
                    <td valign="top">
                        <textarea id="bld_memory_correct_notes" name="bld_memory_correct_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>--%>
                <tr>
                    <td valign="top">
