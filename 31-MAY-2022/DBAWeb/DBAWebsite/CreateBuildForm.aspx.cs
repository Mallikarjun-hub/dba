...
{
    public partial class CreateBuild : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //{
            //    using (SqlCommand cmd = new SqlCommand("usp_Buildform_Question", sqlcon))
            //    {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //memory_correct_dropdownlist_DataBinding();
        ...
        //protected void memory_correct_dropdownlist_DataBinding()
        //{
        //    DataTable build_memorycorrect_info = new DataTable();
        ...
        //            SqlDataAdapter adapter = new SqlDataAdapter("SELECT DISTINCT [Yes No] FROM [dbo].[Dropdown_YesNo];", con);
        //            adapter.Fill(build_memorycorrect_info);
        //            //cmd.CommandType = CommandType.StoredProcedure;
        //            //cmd.Parameters.Add("@query", SqlDbType.VarChar).Value = "yesno";
        //            //conn.Open();
        //            //reader = cmd.ExecuteReader();
        //            //build_memorycorrect_info.Load(reader);

        //            memory_correct_dropdownlistt.DataSource = build_memorycorrect_info;
        //            memory_correct_dropdownlistt.DataTextField = "MailSetup";
        //            memory_correct_dropdownlistt.DataValueField = "MailSetup";
        //            memory_correct_dropdownlistt.DataBind();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string url = ResolveUrl("~/CreateBuildForm.aspx");
                    if (rowsAffected == 1)                        
            ...
            {
                Logging.LogException(ex, "Error while insertingin to database -- buildform");
                string url = ResolveUrl("~/CreateBuildForm.aspx");
                Response.Write(String.Format("<script>alert('OOps there was an error while inserting in to database!');window.location='{0}';</script>", url));               
            }
            finally
