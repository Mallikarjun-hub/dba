<%@ Page Title="EditQAForm" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditQAForm.aspx.cs" Inherits="DBAWebsite.EditQAForm" EnableEventValidation="false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">                                     
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <h2 style="text-align: center;">Edit QA Form for Server: 
    ...
    <form class="htmlform" method="post" action="Web.config">
        ...
        <div id="editablepane" style="line-height: 3.5em;">
            ...
            <tr>
                ...
                <tr>
                    <td valign="top">
                        <label for="services_correct"><b>Unused Services Disabled (SSIS, SSAS, SSRS) *</b></label>
                    </td>
                    <td valign="top">
