<%@ Page Title="EditInventoryForm" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EditInventoryForm.aspx.cs" Inherits="DBAWebsite.EditInventoryForm" EnableEventValidation="false"%>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <h2 style="text-align: center;">Edit Inventory Form for Server: <asp:Label ID="lblhead_servername" runat="server"></asp:Label></h2>
    <br />
        ...
        <div style="line-height: 3.0em;">
            <table width="1000px">
                <tr>
                    ...
                    <td valign="top" style="width:200px;">
                        <asp:Label ID="Label1" runat="server"><b>Old Values</b></asp:Label>
                    </td>       
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_servername_old" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_servername_notes" name="inv_servername_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_Inventory" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_inventorytype_notes" name="inv_inventorytype_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td valign="top">
                     ...
                     <td valign="top">
                        <asp:Label ID="lbl_helpdeskid" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_helpdeskid_notes" name="inv_helpdeskid_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="inv_projectid_notes" name="inv_projectid_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="inv_location_notes" name="inv_location_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_location_id" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_locationid_notes" name="inv_locationid_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                     ...
                     <td valign="top">
                        <asp:Label ID="lbl_environment" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_environment_notes" name="inv_environment_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_application_info" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_applicationinfo_notes" name="inv_applicationinfo_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                     ...
                     <td valign="top">
                        <asp:Label ID="lbl_ITcontact_team" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_itcontactteam_notes" name="inv_itcontactteam_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                     ...
                     <td valign="top">
                        <asp:Label ID="lbl_ITcontact_person" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_itcontactperson_notes" name="inv_itcontactperson_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_Business_contact" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_businesscontact_notes" name="inv_businesscontact_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <label for="sox_complaint"><b>SOX Complaint *</b></label>
                    </td>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_sox_complaint" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_soxcomplaint_notes" name="inv_soxcomplaint_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <asp:Label ID="lbl_backup_type" runat="server"></asp:Label>
                    </td>
                    <td valign="top">
                        <textarea id="inv_backuptype_notes" name="inv_backuptype_notes" cols="30" rows="1"></textarea>
                    </td>
                </tr>
                <%--<tr>
                    <td valign="top">
