...
{
    public partial class EditQAForm : System.Web.UI.Page
    {
        ...
        protected void editQAForm_lables_DataBinding()
        {
            ...
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["myConnectionString"].ConnectionString))
            {
                ...
                try
                {
                    ...
                    {
                        lbl_resource_name_old.Text = editBuildFormlable_Info.Rows[0]["QAResource"].ToString();
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (SqlCommand cmd = new SqlCommand())
                {
                    ...
                    string url = ResolveUrl("~/EditQAForm.aspx");
                    if (rowsAffected == 1)
