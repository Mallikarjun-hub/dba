<%@ Page Title="CreateQAForm" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateQAForm.aspx.cs" Inherits="DBAWebsite.CreateQAForm" EnableEventValidation="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">                                     
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <h2 style="text-align: center;">Create QA Form for Server: 
        ...
        <div id="editablepane" style="line-height: 3.5em;">
            <table width="1000px">
                ...
                <tr>
                    ...
                    <td valign="top">
                        <input type="text" id="txtDate" name ="txtDate"  Style="width: 100px;" />  
                ...
                <tr>
                    ...
                    <td valign="top">
                        <textarea id="memory_correct_notes" name="memory_correct_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
            ...
            <tr>
                    ...
                    <td valign="top">
                        <textarea id="admin_correct_notes" name="admin_correct_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="services_notes" name="services_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                     <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="maintenance_notes" name="maintenance_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="pagelock_notes" name="pagelock_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="version_notes" name="version_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="maxdop_notes" name="maxdop_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                  <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="threshold_notes" name="threshold_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="mixedmode_notes" name="mixedmode_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="countset_notes" name="countset_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="traceflag_notes" name="traceflag_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                 <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="jobsverified_notes" name="jobsverified_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                        <label for="jobssuccessful"><b>SQL Agent jobs all successful, including syspolicy_purge_history *</b></label>
                    </td>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="jobssuccessful_notes" name="jobssuccessful_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="agentalerts_notes" name="agentalerts_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="securitysetup_notes" name="securitysetup_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="accountscorrect_notes" name="accountscorrect_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <tr>
                    <td valign="top">
                    ...
                    <td valign="top">
                        <textarea id="accountsstored_notes" name="accountsstored_notes" cols="40" rows="1"></textarea>
                    </td>
                </tr>
                <%--<tr>
                    <td valign="top">
